...
# How to start?
## Just click the link!
You can start very, very easy! Just click the following link and start using **EasyC4** library: https://app.diagrams.net/?clibs=Uhttps://raw.githubusercontent.com/maciek365/c4-diagrams.net/master/EasyC4&splash=0


## Use it simply!
Simply use elements available in **EasyC4** library to create diagrams in a very convenient way! Just drag elements from the library and double click on it to edit titles and descriptions. This is the most intuitive way to do it quick and easy with keeping an aesthetic and readable form.
...
If the "Format Panel" is not visible then you can show it by clicking one of the icons on the top right.

# Credits
Please share with me your suggestions, ideas, comments, etc. Please feel free to provide me with any feedback -> macieksliwinski80@gmail.com

The C4 model and diagramming approach was created by Simon Brown. More info: https://c4model.com/
